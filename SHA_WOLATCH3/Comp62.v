// -------------------------------------------------------------
// 
// File Name: hdlsrc/expander_power_opt/Comp62.v
...
// 
// Module: Comp62
// Source Path: expander_power_opt/Hardware/SHA1/Compressor1/Comp62
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module Comp62
 ...
 //  begin
  ...
  assign ADD12_out1 = E_IN_REG_out1 - C_IN_REG_out1;
  ...
  assign ADD11_out1 = SIGMA1_out1 + CH_out1;
 ...
 //  begin
  ...
  assign ADD13_out1 = ADD11_out1 + H_IN_REG1_out1;



  assign E_OUT = ADD13_out1;

  assign F_OUT = E_IN_REG_out1;

  assign G_OUT = F_IN_REG_out1;

  assign H_OUT_1 = G_IN_REG_out1;
