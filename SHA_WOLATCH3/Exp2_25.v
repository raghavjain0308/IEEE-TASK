// -------------------------------------------------------------
// 
// File Name: hdlsrc_1/sha_64_unroll/Exp2_25.v
...
// 
// Module: Exp2_25
// Source Path: sha_64_unroll/Hardware/SHA2/Expander2/Exp2_25
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module Exp2_25
 ...
 latch_inv u_latch3 (.clk(clk),.In(In4),.Out(Out4));
 latch_inv u_latch4 (.clk(clk),.In(In5),.Out(Out5));
