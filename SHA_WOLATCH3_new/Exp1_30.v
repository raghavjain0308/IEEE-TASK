// -------------------------------------------------------------
// 
// File Name: hdlsrc_1/sha_64_unroll/Exp1_30.v
...
// 
// Module: Exp1_30
// Source Path: sha_64_unroll/Hardware/SHA1/Expander1/Exp1_30
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module Exp1_30
 ...
 latch u_latch_1(.clk(clk),.In(In8),.Out(Out8));
 latch u_latch_2(.clk(clk),.In(In14),.Out(Out14));
