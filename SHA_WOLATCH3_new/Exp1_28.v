// -------------------------------------------------------------
// 
// File Name: hdlsrc_1/sha_64_unroll/Exp1_28.v
...
// 
// Module: Exp1_28
// Source Path: sha_64_unroll/Hardware/SHA1/Expander1/Exp1_28
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module Exp1_28
  ...
  latch u_latch_1(.clk(clk),.In(In6),.Out(Out6));
 ...
 latch_inv u_latch3 (.clk(clk),.In(In5),.Out(Out5));
